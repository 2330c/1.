...
besieged = ["overwhelm someone with requests or complaints", "verb"]
...
def question(mc):
    ...
    if mc:
        ...
        if pos == "noun":
            ...
            print(key,value,pos)
            thedict = glossary
        choices = random.sample(list(thedict),4) #Four random words
        #TODO: What if there are fewer than 4 words with this pos?
...
for k in glossary:
    v = glossary[k]
    if len(v) < 2:
        print(v,"lacks a part of speech")
    if v[1]=="noun":
        nouns[k]=v
    elif v[1]=="verb":
        verbs[k]=v
